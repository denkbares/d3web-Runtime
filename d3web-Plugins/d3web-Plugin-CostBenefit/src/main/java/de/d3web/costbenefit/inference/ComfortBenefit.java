...
/**
 * This {@link KnowledgeSlice} marks a qContainer that has comfort benefit. If a qContainer has comfort benefit, the
 * condition is true and it does prevent other qcontainers on the path from being applicable, the pathextender adds the
 * QContainer to the Path
 *
...
public class ComfortBenefit implements KnowledgeSlice {
	...
	/**
	 * Creates a ComfortBenefit whose condition is always true. The {@link ComfortBenefit} is automatically added to the
	...
	/**
	 * Creates a ComfortBenefit with the specified condition for the specified QContainer. It will be automatically
	 * added to the {@link KnowledgeStore} of the QContainer.
	 *
	 * @param qContainer QContainer this {@link KnowledgeSlice} belongs to
