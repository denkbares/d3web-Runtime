...
/**
 * This Interface provides a method to start a search in a model. The targets, the nodes etc. are stored in the model.
 *
...
public interface SearchAlgorithm {
	 ...
	 *
	 * @param session the session to calculate the path(s) for
