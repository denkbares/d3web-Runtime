...
public void testCount() {
	...
	Class context = de.d3web.kernel.psMethods.heuristic.PSMethodHeuristic.class;
	Object[] values;

	/*----------------------------------------------
	 	*/

	QuestionNum Mf5 = (QuestionNum) kb.searchQuestions("Mf5");
	QuestionMC Mf7 = (QuestionMC) kb.searchQuestions("Mf7");
...
public void testFormulaSchema() {
	...
	QuestionNum Mf5 = (QuestionNum) kb.searchQuestions("Mf5");
	QuestionNum Mf6 = (QuestionNum) kb.searchQuestions("Mf6");
	QuestionOC Msi4 = (QuestionOC) kb.searchQuestions("Msi4");
	...
	public void testNumericExpression() {
		...
		QuestionNum Mf58 = (QuestionNum) kb.searchQuestions("Mf58");
		QuestionNum Mf6 = (QuestionNum) kb.searchQuestions("Mf6");
		QuestionOC Mf4 = (QuestionOC) kb.searchQuestions("Mf4");
	...
	public void testSetValue() {
		...
		QuestionOC questionOC = (QuestionOC) kb.searchQuestions("Mf2");
