...
/**
 * FragmentHandler for CondNumGreaterEquals
 * 
 * @author Markus Friedrich (denkbares GmbH)
 */
public class NumGreaterEqualConditionHandler implements FragmentHandler {

	@Override
	public boolean canRead(Element element) {
		return XMLUtil.checkCondition(element, "numGreaterEqual");
	}

	@Override
	public boolean canWrite(Object object) {
		return (object instanceof CondNumGreaterEqual);
	}
	...
	public Object read(KnowledgeBase kb, Element element) throws IOException {
		...
		if (questionID != null && value != null) {
			...
			if (idObject instanceof QuestionNum) {
				...
				return new CondNumGreaterEqual(q, Double.parseDouble(value));
			}
		}
		return null;
	}
	...
	public Element write(Object object, Document doc) throws IOException {
		...
		return XMLUtil.writeCondition(doc, cond.getQuestion(), "numGreaterEqual",
