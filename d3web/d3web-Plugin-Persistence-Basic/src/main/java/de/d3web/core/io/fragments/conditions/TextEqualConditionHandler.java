 ...
 * @deprecated {@link CondTextEqual} is deprecated, use {@link CondRegex}
 *             instead
 */
@Deprecated
public class TextEqualConditionHandler implements FragmentHandler<KnowledgeBase> {
	...
	public Element write(Object object, Persistence<KnowledgeBase> persistence) throws IOException {
		...
		return XMLUtil.writeConditionWithValueNode(persistence, cond.getQuestion(), "textEqual",
				cond.getValue());
	}
