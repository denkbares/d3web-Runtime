...
public class QuestionsRendererUtils {
	...
	writer.writeAttribute("id", "region_" + answer.getId(), "id");
	...
	writer.writeAttribute("onclick", "setAnswer('" + answer.getId()
		+ "'); saveLastClickedAnswer('" + answer.getId() + "', ' "
	...
	for (AnswerChoice specAns : ans) {
	    ...
	    if (currentAnswerIsSet(specAns, qChoice, theCase)) {
