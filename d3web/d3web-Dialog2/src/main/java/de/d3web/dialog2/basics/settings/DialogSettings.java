...
public class DialogSettings {
	...
	public void setShowAbstractQuestionsInResultPage(
			boolean showAbstractQuestionsInResultPage) {
	...
	public String getMarginLeftIfLeftPanelFixedCSS() {
		if (leftPanelFixed) return "margin-left: " + (int) leftPanelSizeActual + "%;";
		return "";
	}
	...
	public String getPositionFixedCSS() {
		if (leftPanelFixed) return "leftPanelFixed";
		return "";
	}
