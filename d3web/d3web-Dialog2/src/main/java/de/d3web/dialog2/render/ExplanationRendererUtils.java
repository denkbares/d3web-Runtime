...
import de.d3web.explain.enodes2.ECondition;
import de.d3web.explain.enodes2.ENode;
import de.d3web.explain.enodes2.EReason;
import de.d3web.explain.enodes2.reasons.EPSMethodReason;
import de.d3web.explain.enodes2.reasons.ERuleReason;
	...
	public static void renderTCondition(ResponseWriter writer,
		...
		if (cond instanceof CondEqual) {
			...
			if (ans instanceof ChoiceValue) {
				...
				writer.writeText(Unknown.UNKNOWN_VALUE, "value");
			}
		}
			...
			if (cn instanceof CondNumEqual) writer.write(" = ");
					...
					+ " ", "value");
			else if (cn instanceof CondNumLess) writer.writeText(" "
					+ DialogUtils.getMessageFor("explain.numless") + " ",
					"value");
			else if (cn instanceof CondNumLessEqual) writer.writeText(" "
