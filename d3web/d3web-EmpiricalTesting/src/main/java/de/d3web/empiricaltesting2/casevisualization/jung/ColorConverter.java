...
/**
 * This class converts HTML Colors to
 * Java AWT Colors.
 * 
...
public class ColorConverter {
	...
	/**
	 * Converts a color formatted in HTML style
	 * to a JAVA AWT color.
	 * 
	 * For example #000000 is converted to
	 * Color.BLACK
	 * 
	 * If there is an exception during the
	 * conversion Color.BLACK is returned!
	 * 
	 * @param h String color in HTML style
	 * @return java.awt.Color which is the converted
	 *         HTML color if the conversion was successful
	 *         otherwise it is Color.BLACK 
	 */
