...
/**
 * This class converts CaseObject XML-Files to a TestSuite. The created
 * TestSuite can be written to a file by using either CaseObjectToKnOffice class
 * or CaseObjectToTestSuiteXML class.
 * 
...
public abstract class CaseObjectConverter {
	...
	/**
	 * Cleans equal Solutions with different Ratings. The Solution with the
	 * highest Rating remains in the RTC.
	 * 
