...
public class StateRating implements Rating {
	...
	public StateRating(String rating) {
		s = new de.d3web.core.knowledge.terminology.Rating(rating);
	}
	 ...
	 */
	public StateRating(de.d3web.core.knowledge.terminology.Rating s) {
		this.s = s;
	}
	...
	public int compareTo(Rating o) {
		if (o instanceof StateRating) {
			return s.compareTo((de.d3web.core.knowledge.terminology.Rating) o.getRating());
		}
		return 0;
	}
