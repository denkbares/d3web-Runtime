...
public class TestSuite {
	 ...
	 * If the loading was successful deriveAllSolutions() is called.
	 * @param casesUrl URL-formatted String pointing to a XML Test Case Repository
	 */
	 ...
	 * @param bWriteDerivedSolutions Boolean representing whether derivedSolutions are
	 * 								 written to the output file or not
	 */
	...
	/**
	 * Checks for Consistency of this TestSuite
	 * A TestSuite is consistent, if there exist no two sequential test cases with
	 * 1.) The first (q - 1) sequences of the cases are identical
	 * 2.) The findings in sequence q are identical but their solutions differ
	...
	/**
	 * Calculates the total Interview-Precision of this TestSuite.
	 * During the Interview-Calculation the TestSuite checks if the asked question
	 * in the dialog is exactly the one which was expected in the RatedTestCase.
	...
	/**
	 * Calculates the total Interview-Recall of this TestSuite.
	 * During the Interview-Calculation the TestSuite checks if the asked question
	 * in the dialog is exactly the one which was expected in the RatedTestCase.
