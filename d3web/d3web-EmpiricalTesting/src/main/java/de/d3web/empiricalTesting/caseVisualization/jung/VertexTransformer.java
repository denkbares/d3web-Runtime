...
/**
 * This class transforms Rated-Test-Cases which are 
 * the vertices of our graph into a nice formatted 
...
public class VertexTransformer implements Transformer<RatedTestCase, String> {
	...
	/**
	 * Graph which's vertices are transformed.
	 * This reference is necessary for getting
	 * the questions which are asked next.
	 */
	private CaseTree<RatedTestCase, EdgeFinding> graph;
		
	/**
	 * Provides some methods that are useful during the
	...
	/**
	 * Creates an instance of VertexTransformer backed on
	...
	/**
	 * Transforms RatedTestCase to nice
	 * formatted String which can be used
	 * for rendering.
	 * 
	...
	/**
	 * Loads necessary information from config file
	 * and stores is it in HashMap.
	 * 
	...
	/**
	 * Transforms Finding to nice formatted
	 * String in preparation for rendering.
	 * 
	 * @param rtc Current RatedTestCase
	...
	/**
	 * Transforms solutions to nice formatted
	 * String in preparation for rendering.
	 * 
	 * @param rtc Current RatedTestCase
	 * @param cfg HashMap containing config information
...
//		result.append(getColor(derived, cfg));
	...
	/**
	 * Creates a string representing a list of the
	 * questions which will be asked next.
	 * 
	 * @param rtc The current RatedTestCase.
	 * @param cfg HashMap containing config information.
	 * 
	 * @return String representing a list of answers which
	 *                will be asked next.
	 */
	...
	/**
	 * Creates a list of questions which will
	 * be asked next.
	 * 
	 * @param rtc Current RatedTestCase.
	 * 
