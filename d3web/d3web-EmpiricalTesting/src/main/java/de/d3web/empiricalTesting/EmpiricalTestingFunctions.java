...
public class EmpiricalTestingFunctions {
	...
	public static EmpiricalTestingFunctions getInstance() {
		if (instance == null)
			instance = new EmpiricalTestingFunctions();
		return instance;
	}
	...
	/**
	 * Default Precision Calculation.
	 * Returns the precision of the derived solutions.
	...
	/**
	 * Default Recall Calculation.
	 * Returns the recall of the derived solutions.
	 * @param stc The SequentialTestCase necessary for the Calculation
	...
	/**
	 * Returns the fMeasure of a SequentialTestCase depending on the committed state.
