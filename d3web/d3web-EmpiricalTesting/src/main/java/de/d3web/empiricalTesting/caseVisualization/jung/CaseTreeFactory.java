...
/**
 * This singleton class serves as factory
 * for CaseTree graphs. It converts 
 * TestSuites or Sequential-Test-Cases
 * into a graph.
 * 
 * This class makes extensive use of 
 * components of the JUNG library. The 
 * generated graph can be visualized by 
 * other components of the JUNG library.
 *   
...
public class CaseTreeFactory {
	 ...
	 * @return CaseTree<RatedTestCase, EdgeFinding> representing
	 *         the committed List<SequentialTestCase>
	 */
	 ...
	 * @param testsuite TestSuite which contains a
	...
	private void addVertex(CaseTree<RatedTestCase, EdgeFinding> graph, 
		...
		if (previousRTC != null	
			...
			try {
				EdgeFinding edge = new EdgeFinding(previousRTC, currentRTC, currentRTC.getFindings().get(0));
