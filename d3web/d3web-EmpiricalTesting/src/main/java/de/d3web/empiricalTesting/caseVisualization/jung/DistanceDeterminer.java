...
/**
 * This class is a heuristic which determines the vertical
...
public class DistanceDeterminer {
	...
	/**
	 * Determines the distance between two vertices on basis
	 * of the maximum number of RatedSolutions.
	...
	public int determineDistance(Collection<RatedTestCase> cases) {
		...
		for (RatedTestCase rtc : cases) {
			if (rtc.getExpectedSolutions().size() > result)
