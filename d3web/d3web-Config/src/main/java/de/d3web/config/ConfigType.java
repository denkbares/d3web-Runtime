...
/**
 * ConfigType (in ) de.d3web.config d3web-Config
 * 
 * @author hoernlein
 * @date 01.12.2003
 */
public class ConfigType {
	...
	static {
		...
		ConfigGroup gr_dialog_mqdialogboxed = new ConfigGroup(
				"dialog.MultipleQuestionDialogs.MQDialogBoxed");
		...
		ConfigGroup gr_dialog_diagclarification_plugin = new ConfigGroup(
				"dialog.DiagClarificationPlugin");
