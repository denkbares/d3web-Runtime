...
/**
 * Handles QuestionComparatorNumDivision
 * 
 * @author Markus Friedrich (denkbares GmbH)
 */
public class QuestionComparatorNumDivisionHandler extends
		QuestionComparatorHandler {

	@Override
	protected String getType() {
		return "QuestionComparatorNumDivision";
	}

	@Override
	public boolean canWrite(Object object) {
		return object instanceof QuestionComparatorNumDivision;
	}

	@Override
	protected QuestionComparator getQuestionComparator() {
		return new QuestionComparatorNumDivision();
	}
