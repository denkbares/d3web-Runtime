 ...
 */
public class QuestionComparatorYNHandler extends QuestionComparatorHandler {

	@Override
	protected String getType() {
		return "QuestionComparatorYN";
	}

	@Override
	public boolean canWrite(Object object) {
		return (object instanceof QuestionComparatorYN);
	}

	@Override
	protected QuestionComparator getQuestionComparator() {
		return new QuestionComparatorYN();
	}
