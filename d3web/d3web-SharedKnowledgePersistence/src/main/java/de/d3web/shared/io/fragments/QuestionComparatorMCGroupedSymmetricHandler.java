...
public class QuestionComparatorMCGroupedSymmetricHandler extends
	...
	public boolean canRead(Element element) {
		return XMLUtil.checkNameAndType(element, "KnowledgeSlice", getType())
			//in previous versions of the persistence, the type of the slices was QuestionComparatorMCGrouped
			|| XMLUtil.checkNameAndType(element, "KnowledgeSlice", "QuestionComparatorMCGrouped");
	}
}
