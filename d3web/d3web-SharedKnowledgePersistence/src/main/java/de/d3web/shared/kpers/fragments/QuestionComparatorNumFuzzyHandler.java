...
public class QuestionComparatorNumFuzzyHandler extends
	...
	public Element write(Object object, Document doc) throws IOException {
		...
		fuzzyParametersElement.setAttribute("increasingLeft", doubleToString(qcnf.getIncreasingLeft()));
		...
		fuzzyParametersElement.setAttribute("decreasingRight", doubleToString(qcnf.getDecreasingRight()));
