...
/**
 * Handles QuestionComparatorMCIndividual
 * 
 * @author Markus Friedrich (denkbares GmbH)
 */
public class QuestionComparatorMCIndividualHandler extends
		QuestionComparatorHandler {

	@Override
	protected String getType() {
		return "QuestionComparatorMCIndividual";
	}

	@Override
	public boolean canWrite(Object object) {
		return object instanceof QuestionComparatorMCIndividual;
	}

	@Override
	protected QuestionComparator getQuestionComparator() {
		return new QuestionComparatorMCIndividual();
	}
