...
/**
 * Handles QuestionComparatorOCIndividual
 *
 * @author Markus Friedrich (denkbares GmbH)
 */
public class QuestionComparatorOCIndividualHandler extends
		QuestionComparatorHandler {

	@Override
	protected QuestionComparator getQuestionComparator() {
		return new QuestionComparatorOCIndividual();
	}

	@Override
	protected String getType() {
		return "QuestionComparatorOCIndividual";
	}

	@Override
	public boolean canWrite(Object object) {
		return object instanceof QuestionComparatorOCIndividual;
	}
