...
/**
 * The is the common interface of all Verbalizers.
 * A verbalizer is a class, that can verbalize (render to String representations) objects.
 * The objects and formats a verbalizers supports have to be specified in the appropriate methods.
 * 
