...
public class DateHandler implements FragmentHandler {
	...
	private static final String elementName = "date";

	@Override
	public Object read(KnowledgeBase kb, Element element) throws IOException {
		try {
			SimpleDateFormat dateFormat = SessionPersistenceManager.DATE_FORMAT;
			return dateFormat.parse(element.getTextContent());
		}
