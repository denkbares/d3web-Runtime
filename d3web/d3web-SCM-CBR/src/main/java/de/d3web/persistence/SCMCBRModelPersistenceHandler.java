...
public class SCMCBRModelPersistenceHandler implements KnowledgeReader,
	...
	private void addKnowledge(KnowledgeBaseManagement kbm, Node current) throws IOException {
		...
		String coveringEstablishedThreshold = getAttribute("coveringEstablishedThreshold",
				current);
		String completenessSuggestedThreshold = getAttribute("completenessSuggestedThreshold",
				current);
	...
	public Element getModelElement(SCMCBRModel o, Document doc) throws IOException {
		...
		modelelement.setAttribute("coveringSuggestedThreshold", ""
				+ o.getCoveringSuggestedThreshold());
		modelelement.setAttribute("coveringEstablishedThreshold", ""
				+ o.getCoveringEstablishedThreshold());
		modelelement.setAttribute("completenessSuggestedThreshold", ""
				+ o.getCompletenessSuggestedThreshold());
		modelelement.setAttribute("completenessEstablishedThreshold", ""
				+ o.getCompletenessEstablishedThreshold());
		modelelement.setAttribute("ID", o.getId());
		modelelement.setAttribute("SID", o.getSolution().getId());
		modelelement.appendChild(getRelationsElement(o.getNecessaryRelations(),
				"necessaryRelations", doc));
		modelelement.appendChild(getRelationsElement(o.getSufficientRelations(),
				"sufficientRelations", doc));
		modelelement.appendChild(getRelationsElement(o.getContradictingRelations(),
