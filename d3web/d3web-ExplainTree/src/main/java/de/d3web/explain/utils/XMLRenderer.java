...
public class XMLRenderer {
	...
	public static StringBuffer renderVerbalizations(ResourceBundle rb) {
		...
		sb.append("<ReasonBeginning><![CDATA[" + rb.getString("explain.reason_beginning")
				+ "]]></ReasonBeginning>");
		sb.append("<ConcrDerivationBeginning><![CDATA["
				+ rb.getString("explain.concrete_derivation_beginning")
				+ "]]></ConcrDerivationBeginning>");
		sb.append("<DerivationBeginning><![CDATA["
				+ rb.getString("explain.derivation_beginning")
				+ "]]></DerivationBeginning>");
		sb.append("<IFVerb><![CDATA[" + rb.getString("explain.if_verb") + "]]></IFVerb>");
		sb.append("<ExceptionVerb><![CDATA[" + rb.getString("explain.exception_verb")
				+ "]]></ExceptionVerb>");
		sb.append("<ContextVerb><![CDATA[" + rb.getString("explain.context_verb")
				+ "]]></ContextVerb>");
		sb.append("<NotVerb><![CDATA[" + rb.getString("explain.not_verb")
				+ "]]></NotVerb>");
		sb.append("<OrVerb><![CDATA[" + rb.getString("explain.or_verb") + "]]></OrVerb>");
		sb.append("<AndVerb><![CDATA[" + rb.getString("explain.and_verb")
				+ "]]></AndVerb>");
		sb.append("<MofNVerb><![CDATA[" + rb.getString("explain.mofn_connector_verb")
				+ "]]></MofNVerb>");
		sb.append("<KnownVerb><![CDATA[" + rb.getString("explain.known")
				+ "]]></KnownVerb>");
		sb.append("<UnknownVerb><![CDATA[" + rb.getString("explain.unknown")
				+ "]]></UnknownVerb>");
		sb.append("<NumGreaterVerb><![CDATA[" + rb.getString("explain.numgreater")
				+ "]]></NumGreaterVerb>");
		sb.append("<NumGreaterEqualVerb><![CDATA["
				+ rb.getString("explain.numgreater_equal") + "]]></NumGreaterEqualVerb>");
		sb.append("<NumLessVerb><![CDATA[" + rb.getString("explain.numless")
				+ "]]></NumLessVerb>");
		sb.append("<NumLessEqualVerb><![CDATA[" + rb.getString("explain.numless_equal")
				+ "]]></NumLessEqualVerb>");
		sb.append("<NumInVerb><![CDATA[" + rb.getString("explain.numin")
				+ "]]></NumInVerb>");
		sb.append("<TextContainsVerb><![CDATA[" + rb.getString("explain.textcontains")
				+ "]]></TextContainsVerb>");
		sb.append("<TodayVerb><![CDATA[" + rb.getString("explain.date.today")
				+ "]]></TodayVerb>");
		sb.append("<MofNExact1Verb><![CDATA[" + rb.getString("explain.mofn_exact_1")
				+ "]]></MofNExact1Verb>");
		sb.append("<MofNExactVerb><![CDATA[" + rb.getString("explain.mofn_exact_more")
				+ "]]></MofNExactVerb>");
		sb.append("<MofNMin1Verb><![CDATA[" + rb.getString("explain.mofn_min_1")
				+ "]]></MofNMin1Verb>");
		sb.append("<MofNMinVerb><![CDATA[" + rb.getString("explain.mofn_min_more")
				+ "]]></MofNMinVerb>");
		sb.append("<MofNMax1Verb><![CDATA[" + rb.getString("explain.mofn_max_1")
				+ "]]></MofNMax1Verb>");
		sb.append("<MofNMaxVerb><![CDATA[" + rb.getString("explain.mofn_max_more")
				+ "]]></MofNMaxVerb>");
		sb.append("<MofNInVerb><![CDATA[" + rb.getString("explain.mofn_in")
				+ "]]></MofNInVerb>");
		sb.append("<DiagEstablishedVerb><![CDATA["
				+ rb.getString("explain.diag_established") + "]]></DiagEstablishedVerb>");
		sb.append("<DiagSuggestedVerb><![CDATA[" + rb.getString("explain.diag_suggested")
				+ "]]></DiagSuggestedVerb>");
		sb.append("<DiagUnclearVerb><![CDATA[" + rb.getString("explain.diag_unclear")
				+ "]]></DiagUnclearVerb>");
		sb.append("<DiagExcludedVerb><![CDATA[" + rb.getString("explain.diag_excluded")
				+ "]]></DiagExcludedVerb>");
		sb.append("<DiagScoreUnitVerb><![CDATA[" + rb.getString("explain.diag_scoreunit")
				+ "]]></DiagScoreUnitVerb>");
		sb.append("<QuestionIndicationVerb><![CDATA["
				+ rb.getString("explain.question_indication")
				+ "]]></QuestionIndicationVerb>");
		sb.append("<ParentQASetIndicationVerb><![CDATA["
				+ rb.getString("explain.parent-qaset_indication")
				+ "]]></ParentQASetIndicationVerb>");
		sb.append("<ParentQASetContraIndicationVerb><![CDATA["
				+ rb.getString("explain.parent-qaset_contraindication")
				+ "]]></ParentQASetContraIndicationVerb>");
		sb.append("<QContainerIndicationVerb><![CDATA["
				+ rb.getString("explain.container_indication")
				+ "]]></QContainerIndicationVerb>");
		sb.append("<QContainerContraIndicationVerb><![CDATA["
				+ rb.getString("explain.container_contraindication")
				+ "]]></QContainerContraIndicationVerb>");
		sb.append("<InitialQuestionVerb><![CDATA["
				+ rb.getString("explain.initial_question") + "]]></InitialQuestionVerb>");
		sb.append("<InitialQContainerVerb><![CDATA["
				+ rb.getString("explain.initial_container")
				+ "]]></InitialQContainerVerb>");
		sb.append("<NoKnowledgeVerb><![CDATA["
				+ rb.getString("explain.no_knowledge_available")
				+ "]]></NoKnowledgeVerb>");
		sb.append("<NoActiveRuleVerb><![CDATA[" + rb.getString("explain.no_active_rule")
				+ "]]></NoActiveRuleVerb>");
		sb.append("<QuestionVerb><![CDATA[" + rb.getString("explain.question_verb")
				+ "]]></QuestionVerb>");
		sb.append("<QContainerVerb><![CDATA[" + rb.getString("explain.container_verb")
				+ "]]></QContainerVerb>");
		sb.append("<DiagnosisVerb><![CDATA[" + rb.getString("explain.diagnosis_verb")
				+ "]]></DiagnosisVerb>");
		sb.append("<UserSelectedVerb><![CDATA[" + rb.getString("explain.user_selected")
				+ "]]></UserSelectedVerb>");
		sb.append("<SchemaVerb><![CDATA[" + rb.getString("explain.schema_verb")
				+ "]]></SchemaVerb>");
		sb.append("<SchemaSmallerVerb><![CDATA["
				+ rb.getString("explain.schema_smaller_verb") + "]]></SchemaSmallerVerb>");
		sb.append("<SchemaBetweenVerb><![CDATA["
				+ rb.getString("explain.schema_between_verb") + "]]></SchemaBetweenVerb>");
		sb.append("<SchemaGreaterEqualVerb><![CDATA["
				+ rb.getString("explain.schema_greater-equal_verb")
				+ "]]></SchemaGreaterEqualVerb>");
	...
	private static StringBuffer renderQASetObject(QASet qaSet) {
		...
		if (qaSet instanceof Question) {
			if (isSiQASet(qaSet)) sb.append("<SI ID=\"");
			else sb.append("<Question ID=\"");
		}
		else sb.append("<QContainer ID=\"");
		sb.append(qaSet.getId());
		sb.append("\"><![CDATA[");
		sb.append(qaSet.getName());
		if (qaSet instanceof Question) {
			if (isSiQASet(qaSet)) sb.append("]]></SI>");
			else sb.append("]]></Question>");
		}
		else sb.append("]]></QContainer>");
		return (sb);
	}
	...
	public static StringBuffer renderReference(Solution diag, Session theCase, boolean showStatus) {
		...
		if (showStatus) {// renderDiagnosisStateObject
			...
			if (state instanceof HeuristicRating) {
				...
				sb.append("<DiagnosisScore ID=\"" + hr.getScore() + "\"/>");
			}
		}
		sb.append("</Reference>");
		return (sb);
	...
	public static StringBuffer renderQASetReasons(QASet qaSet, Session theCase, Class<? extends PSMethod> context, boolean showStatus) {
		...
		if (c != null) {
			...
			if (qaSet instanceof QContainer) {
				// Frageklasse ist Startfrageklasse, wenn es in
				// getInitQuestions() enthalten ist
	...
	public static List<?> renderAction(Rule rc) {
		...
		if (rc.getAction() instanceof ActionHeuristicPS) {
			...
			// ActionContraIndication ac =
			// (ActionContraIndication)rc.getAction();
	...
	public static StringBuffer renderTCondition(TerminalCondition cond, Session theCase,
		...
		if (cond instanceof CondEqual) {
			...
			Choice toRender;
			if (cond instanceof CondChoiceNo) toRender = ((QuestionYN) cq.getQuestion()).no;
			else toRender = ((QuestionYN) cq.getQuestion()).yes;
			...
			if (cn instanceof CondNumEqual) sb.append(" type=\"numEqual\"");
	...
	private static StringBuffer getSchemaInfoFor(QuestionOC q) {
		...
		// show the schema only, if there is exactly one more alternative than
		// schema-value
		if ((alternatives != null) && (alternatives.size() != 0)
				&& (schemaArray.length != 0)
				&& (alternatives.size() == schemaArray.length + 1)) {
			sb.append("<Schema>");

			sb.append("<Correlation max=\"" + (schemaArray[0]).intValue() + "\">");
			sb.append(renderAnswerChoiceObject(alternatives.get(0)));
			...
			for (int i = 1; i < schemaArray.length; i++) {
				...
				sb.append(renderAnswerChoiceObject(alternatives.get(i)));
				sb.append("</Correlation>");
			}

			sb.append("<Correlation min=\""
					+ (schemaArray[schemaArray.length - 1]).intValue() + "\">");
			sb.append(renderAnswerChoiceObject(alternatives.get(alternatives.size() - 1)));
			sb.append("</Correlation>");
	...
	private static List<Object> getStatusFor(Condition cond, Session theCase,
		...
		try {
			if (cond.eval(theCase)) {
				...
				if (asException) {
					...
					else returnList.add("exFiredEffectless");
				}
				else returnList.add("fired");
			}
		}
		...
		if (returnList.size() == 0) {
			returnList.add(new Boolean(false));
			if (asException) returnList.add("exNotFired");
			else returnList.add("notFired");
		}
		return (returnList);
	}

	/**
	 * The List "toInsert" has to have one or two Elements. If one: (Object); if
	 * two: (Object,Double). If the list has only one Element, it will be
	 * inserted at the end. If it has two Elements, it will be inserted, so that
	 * the "sortedList"is sorted by the Double-values of the "toInsert"-Lists
	 * (descending)
	 * 
	 * @param sortedList
