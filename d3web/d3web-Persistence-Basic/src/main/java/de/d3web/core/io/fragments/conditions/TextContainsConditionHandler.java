...
public class TextContainsConditionHandler implements FragmentHandler {
	...
	public boolean canRead(Element element) {
		return XMLUtil.checkCondition(element, "textContains");
	}

	@Override
	public boolean canWrite(Object object) {
		return (object instanceof CondTextContains);
	}
		...
		if (questionID!=null) {
			...
			if (idObject instanceof QuestionText) {
				...
				if (item != null && childNodes.getLength()== 1) {
					return new CondTextContains(q, item.getTextContent());
				}
			}
		}
		return null;
	...
	public Element write(Object object, Document doc) throws IOException {
		...
		return XMLUtil.writeConditionWithValueNode(doc, cond.getQuestion(), "textContains", cond.getValue());
	}
