 ...
 */
public class NumLessConditionHandler implements FragmentHandler {

	@Override
	public boolean canRead(Element element) {
		return XMLUtil.checkCondition(element, "numLess");
	}

	@Override
	public boolean canWrite(Object object) {
		return (object instanceof CondNumLess);
	}
	...
	public Object read(KnowledgeBase kb, Element element) throws IOException {
		...
		if (questionID!=null && value != null) {
			...
			if (idObject instanceof QuestionNum) {
				...
				return new CondNumLess(q, Double.parseDouble(value));
			}
		}
		return null;
	}
	...
	public Element write(Object object, Document doc) throws IOException {
		...
		return XMLUtil.writeCondition(doc, cond.getQuestion(), "numLess", cond.getConditionValue().toString());
	}
