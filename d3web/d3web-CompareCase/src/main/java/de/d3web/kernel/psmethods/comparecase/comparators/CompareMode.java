...
public class CompareMode {
	...
	public static final CompareMode NO_FILL_UNKNOWN = new CompareMode(new int[] {
			0, 0 });
	public static final CompareMode COMPARE_CASE_FILL_UNKNOWN = new CompareMode(new int[] {
			0, 1 });
	public static final CompareMode BOTH_FILL_UNKNOWN = new CompareMode(new int[] {
			1, 1 });
	public static final CompareMode CURRENT_CASE_FILL_UNKNOWN = new CompareMode(new int[] {
			1, 0 });
	public static final CompareMode JUNIT_TEST = new CompareMode(new int[] {
