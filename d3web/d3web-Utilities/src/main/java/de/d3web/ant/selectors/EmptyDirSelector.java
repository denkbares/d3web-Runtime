...
/**
 * EmptyDirSelector (in ) de.d3web.ant.selectors d3web-Utilities
 * 
 * @author hoernlein
 * @date 17.05.2004
 */
public class EmptyDirSelector implements ExtendFileSelector {
	 ...
	 * 
	 * @see
	 * org.apache.tools.ant.types.selectors.FileSelector#isSelected(java.io.
	 * File, java.lang.String, java.io.File)
	 */
	public boolean isSelected(File baseDir, String fileName, File file) throws BuildException {
		// System.err.println("isSelected " + baseDir + " " + fileName + " " +
		// file);
	 ...
	 * 
	 * @see
	 * org.apache.tools.ant.types.Parameterizable#setParameters(org.apache.tools
	 * .ant.types.Parameter[])
	 */
