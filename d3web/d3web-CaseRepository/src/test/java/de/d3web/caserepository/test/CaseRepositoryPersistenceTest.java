...
public class CaseRepositoryPersistenceTest extends TestCase {
	...
	public void testSingleXMLLoading() throws Exception {
		File caseFile = new File(System.getProperty("user.dir") + "/src/test/resources/carDiagnosis_cases.xml");
		...
		assertNotNull("CaseObject with ID \"855859\" wasn't found.", repository.getCaseObjectById("8558590"));
		assertNotNull("CaseObject with ID \"9979645\" wasn't found.", repository.getCaseObjectById("9979645"));
	...
	public void testSingleXMLSaving() throws Exception {
		...
		File oldFile = new File(System.getProperty("user.dir") + "/src/test/resources/carDiagnosis_cases.xml");
