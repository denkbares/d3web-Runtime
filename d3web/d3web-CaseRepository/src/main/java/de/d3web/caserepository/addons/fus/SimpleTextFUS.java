...
public class SimpleTextFUS implements XMLCodeGenerator, ISolutionContainer {
	...
	public void setDiagnosesTreeRootId(String diagnosesTreeRootId) {
        if (diagnosesTreeRootId != null && diagnosesTreeRootId.trim().equals(""))
            ...
            this.diagnosesTreeRootId = diagnosesTreeRootId;
	}
	...
	/**
	 * @param therapiesTreeRootId
	 *            The therapiesTreeRootId to set.
	 */
	public void setTherapiesTreeRootId(String therapiesTreeRootId) {
        if (therapiesTreeRootId != null && therapiesTreeRootId.trim().equals(""))
            this.therapiesTreeRootId = null;
        else
            this.therapiesTreeRootId = therapiesTreeRootId;
	}
