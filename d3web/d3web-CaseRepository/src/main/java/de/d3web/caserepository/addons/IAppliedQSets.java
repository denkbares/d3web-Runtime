...
public interface IAppliedQSets extends XMLCodeGenerator {
	...
	/**
	 * sets QContainer as "applied" i.e. at least one question in this container
	 * has answers
	 * 
	 * @param c QContainer
	 */
	...
	/**
	 * 
	 * @return Set of QContainers which are set "applied". This Set must be
	 *         ordered.
	 */
	...
	/**
	 * sets QContainer as "essential" i.e. to be able to solve the case the
	 * answers to all contained questions must be known
	 * 
	 * @param c QContainer
	 */
	...
	/**
	 * sets QContainer as "start" i.e. if the case is started, all QContainers
	 * set as "start" are immediately answered
	 * 
	 * @param c QContainer
	 */
