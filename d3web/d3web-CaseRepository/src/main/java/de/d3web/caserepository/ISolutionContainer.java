...
public interface ISolutionContainer {
	...
	/**
	 * Returns a CaseObject.Solution element, containing the weight and rating
	 * for the different contexts.<br>
	 * PriorityGroup may be null. If null, getSolution returns the
	 * "end"-solution, otherwise the solution given for this priority group.<br>
	...
	/**
	 * Returns a Set containing all CaseObject.Solutions set in this case with
	 * given psMethodClass
	 * 
	 * @return Set
	 */
