...
/**
 * Abstract implementation of the CaseRepositoryPersistenceHandler Interface
 * which offers some basic methods needed in all Implementations
 * 
...
public abstract class AbstractCaseRepositoryHandler implements CaseRepositoryPersistenceHandler {
	...
	/**
	 * Returns an instance of CaseRepositoryReader which is necessary for
	 * loading CaseRepositories.
	 * 
	 * @return instance of CaseRepositoryReader
	 */
	public CaseRepositoryReader getCaseRepositoryReader() {
		if (cr == null) cr = new CaseRepositoryReader();
		return cr;
	}

	/**
	 * Returns an instance of CaseRepositoryWriter which is necessary for saving
	 * CaseRepositories.
	 * 
	 * @return instance of CaseRepositroyWriter
	 */
	public CaseRepositoryWriter getCaseRepositoryWriter() {
		if (cw == null) cw = new CaseRepositoryWriter();
		return cw;
	}
