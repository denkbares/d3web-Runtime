...
public interface ProgressNotifier {
	...
	/**
	 * fires a ProgressEvent, notifies all Listners for the specified Progress
	 * Type
	 * 
	 * @param ProgressType
	 * @param evt
	...
	/**
	 * returns the approx. Time in ms the operation will need. used to weight
	 * the operation time for long operations with little maxvalue to the time
	 * of short operations with long maxvalue. Should be balanced to the time
	 * the operations take for processing. additional Information may support
	 * additionalInformation for the operation
	 * 
	 * @param ProgressType
	 * @return
	 */
