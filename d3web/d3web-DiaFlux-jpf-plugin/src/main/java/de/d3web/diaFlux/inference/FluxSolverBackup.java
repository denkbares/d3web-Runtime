...
//
//		List ks = (List) base.getKnowledge(FluxSolverBackup.class, FluxSolverBackup.DIAFLUX);
//
//		FlowSet flowSet;
//		if (ks == null) {
//			flowSet = new FlowSet(title);
//			base.addKnowledge(FluxSolverBackup.class, flowSet, FluxSolverBackup.DIAFLUX);
//
//		}
//		else {
...
//
//		List knowledge = (List) knowledgeBase.getKnowledge(FluxSolverBackup.class,
...
//	 * @return
//	 */
//	private static IEdge selectNextEdge(Session theCase, PathEntry currentEntry) {
//
...
//			KnowledgeSlice knowledge = ((NamedObject) object).getKnowledge(FluxSolverBackup.class,
//					MethodKind.FORWARD);
//			if (knowledge != null) {
