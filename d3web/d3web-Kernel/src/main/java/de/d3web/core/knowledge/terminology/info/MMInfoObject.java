...
public class MMInfoObject implements DCMarkedUp {
	...
	/**
	 * @return true, iff all content in dcData equals to content in
	 *         this.getDCData example:
	 * 
	 *         this->DCData DCElement.SUBJECT = "foo" DCElement.LANGUAGE = "de"
	 * 
	 ...
	 * 
	 *         dcData DCElement.SUBJECT = "foo" DCElement.LANGUAGE = "de"
	 * 
	 *         -> no match!
	 * 
	 */
