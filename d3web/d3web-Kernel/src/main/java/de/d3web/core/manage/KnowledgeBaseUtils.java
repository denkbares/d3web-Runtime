...
public final class KnowledgeBaseUtils {
    ...
    public static MultiMap<Solution, Solution> groupSolution(Collection<Solution> solutions) {
    ...
    public static void groupSolution(Solution solution, MultiMap<Solution, Solution> groups) {
