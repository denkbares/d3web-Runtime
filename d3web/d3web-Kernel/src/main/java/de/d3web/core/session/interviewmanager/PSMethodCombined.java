...
/**
 * A generic class for combining different problem solving methods. Can be used
 * for information retrieval based upon multiple problem solving methods states.
