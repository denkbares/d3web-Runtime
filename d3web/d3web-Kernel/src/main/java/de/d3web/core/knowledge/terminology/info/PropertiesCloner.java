...
import de.d3web.indication.inference.BooleanPropertyCloner;
import de.d3web.indication.inference.DCMarkupPropertyCloner;
import de.d3web.indication.inference.DoublePropertyCloner;
import de.d3web.indication.inference.IntegerPropertyCloner;
import de.d3web.indication.inference.LinkedListPropertyCloner;
import de.d3web.indication.inference.PropertyCloner;
import de.d3web.indication.inference.StringPropertyCloner;
import de.d3web.indication.inference.URLPropertyCloner;
...
public class PropertiesCloner {
	 ...
	 * 
	 * @param properties Properties to clone
	 * @param verbose Only warn about non-cloneable properties, when enabled!
	 * @return a deep copy of the given properties
	 */
