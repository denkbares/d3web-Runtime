...
public class CondDateEqual extends CondDate {
	 ...
	 * question needs to be equal to the specified value.
	...
	public boolean equals(Object other) {
		...
		if (this.getValue() != null && ((CondDateEqual)other).getValue() != null)
			return this.getValue().equals(((CondDateEqual)other).getValue());
