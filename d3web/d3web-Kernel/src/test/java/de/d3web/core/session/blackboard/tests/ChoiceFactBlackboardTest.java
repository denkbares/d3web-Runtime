...
public class ChoiceFactBlackboardTest {
	...
	/**
	 * For one-choice question 'weekday' the values 'monday' and 'tuesday' 
	 * are set subsequently. Different sources are used for this, so 
	 * after retracting 'tuesday', the older value 'monday' should be 
	 * valid again.
	 * 
	 * 1)                                  :: weekday = undefined?
	 * 2) set weekday = monday (source1)   :: weekday = monday?
	 * 3) set weekday = tuesday (source2)  :: weekday = tuesday?
	 * 4) retract weekday = tuesday        :: weekday = monday?
	 */
	@Test
	public void testOneChoiceValueFactDifferentSource() {

		// Check, whether the blackboard returns 'undefined' when no fact available
		...
		// Assign another value 'tuesday' to 'weekday'; same source, should overwrite 'monday'
	...
	/**
	 * For one-choice question 'weekday' the values 'Monday' and 'Tuesday' 
	 * are set subsequently. The same sources are used for this, so 
	 * the first value is overwritten and after retracting 'Tuesday', the 
	 * value of the question should be Undefined again.
	 * 
	 * 1)                           :: weekday = undefined?
	 * 2) set weekday = monday      :: weekday = monday?
	 * 3) set weekday = tuesday     :: weekday = tuesday?
	 * 4) retract weekday = tuesday :: weekday = undefined?
	 */
	@Test
	 ...
	 * are set subsequently. The same sources are used for this, so 
	 * the first value is overwritten and after retracting 'red+green', 
	 * the value of the question should be Undefined again.
	 * 
	 * 1)                           :: check color = undefined ?
	 * 2) set color = red           :: check: red?
	 * 3) set color = red+green     :: check: red+green? 
	 * 4) retract color = red+green :: check: undefined? 
	 */
	@Test
	public void testMultipleChoiceValueFactSameSource() {
		...
		// Retract last fact, then 'undefined' should be valid again, due to same source
	 ...
	 * For multiple-choice question 'colors' the values 'red' and 'red+green' 
	 * are set subsequently. Different sources are used for this, so 
	 * after retracting 'red+green', the value of the question
	 * should be 'red' again.
	 * 
	 * 1)                                     :: check color = undefined ?
	 * 2) set color = red (source1)           :: check: red?
	 * 3) set color = red+green (source2)     :: check: red+green?
	 * 4) retract color = red+green (source2) :: check: red? 
	 * 
	 */
	@Test
	...
	private static void addTerminologyObjects() {
		// Question 'weekday'
		String[] weekdayAlternatives = new String[] { "Monday", "Tuesday",
