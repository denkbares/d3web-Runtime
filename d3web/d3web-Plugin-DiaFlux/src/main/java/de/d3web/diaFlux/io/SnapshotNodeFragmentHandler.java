 ...
 * @created 11.11.2010
 */
public class SnapshotNodeFragmentHandler extends AbstractNodeFragmentHandler {
	...
	public Element write(Object object, Persistence<KnowledgeBase> persistence) throws IOException {
		...
		Element snapshotElement = persistence.getDocument().createElement(SNAPSHOT);
		nodeElement.appendChild(snapshotElement);

		snapshotElement.appendChild(persistence.getDocument().createTextNode(node.getName()));
