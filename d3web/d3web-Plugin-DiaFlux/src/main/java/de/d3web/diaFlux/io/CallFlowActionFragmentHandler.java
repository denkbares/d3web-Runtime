...
public class CallFlowActionFragmentHandler implements FragmentHandler {
	...
	public Object read(KnowledgeBase kb, Element element) throws IOException {
		String flowName = element.getElementsByTagName(FLOW_NAME).item(0).getTextContent();
		String startNodeName = element.getElementsByTagName(START_NODE_NAME).item(0).getTextContent();
	...
	public boolean canRead(Element element) {
		return XMLUtil.checkNameAndType(element, ActionNodeFragmentHandler.ACTION, CALL_FLOW);
	}
