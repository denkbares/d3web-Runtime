...
/**
 * This class decorates the standard {@link Rating} of a solution by a numeric score that is used to represent the
 * derivation value of this solution in the context of the problem-solver {@link PSMethodHeuristic}.
 *
 * @author joba
 * @created 18.08.2010
 */
public class HeuristicRating extends Rating {
	...
	/**
	 * Sums up a number of HeuristicRatings, creating a new one that represents the combined score.
	 *
	 * @param apriori null or the apriory score to be applied
	 * @param ratings the ratings to be summed
	 */
	public static HeuristicRating add(float apriori, HeuristicRating... ratings) {
		double score = 0.0;
