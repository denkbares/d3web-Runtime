...
/**
 * A terminal condition that always returns true. In addition a set of terminals can be specified to which objects the
 * condition "is connected to" (e.g. on what changes a rule using that condition should be evaluated.
 * <p>
 * This class is not intended to be used directly by users. In contrast it is a utility condition to handle specific
